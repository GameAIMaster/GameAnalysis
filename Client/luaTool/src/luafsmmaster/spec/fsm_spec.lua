--require("lua-state-machine-master.spec.busted")

local machine = require('lua-state-machine-master.spec.statemachine')
local _ = require("lua-state-machine-master.spec.luassert.match")._
